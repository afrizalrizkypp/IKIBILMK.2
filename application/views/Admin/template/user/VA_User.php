                    ...
                    <div class="card">
                        ...
                        <div class="card-content table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td><?php echo $n->kd_ulangan;?></td>     
                                        <td><?php echo $n->nm_mapel;?></td>
                                        <td><?php echo $n->nilai_ulangan;?></td>
                                        <td>
                                            <?php echo anchor('C_Ulangan/update/'.$n->id,'<i title="Update" class="material-icons">edit</i>'); ?>
                                            <?php echo anchor('C_Ulangan/delete/'.$n->id,'<i title="Delete" class="material-icons">close</i>'); ?> 
                                        </td>
                                    </tr>
                                </tbody>
                                <?php } ?>
